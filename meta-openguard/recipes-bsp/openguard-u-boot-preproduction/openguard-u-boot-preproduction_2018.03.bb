require recipes-bsp/openguard-u-boot-preproduction/u-boot.inc

DESCRIPTION = "U-Boot for Marvell Embedded Processors (pre-production)"
LICENSE = "GPLv2"
LIC_FILES_CHKSUM = "file://README;md5=8ff0837b355cf37b6b956f316d010d0c"

PROVIDES = "openguard-u-boot-preproduction"
...
do_install_append() {
    ...
    cd ${S}
    GZIP=-1 tar -zcf ${DEPLOY_DIR_IMAGE}/u-boot-preproduction-openguard-sources.tar.gz *
    cd -
}
